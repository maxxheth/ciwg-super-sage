...
@section('content')
    <main class="flex-1">
        ...
        <x-ui.section>
            <div class="grid grid-cols-1 gap-12 items-center justify-center">
                <div class="space-y-6 animate-on-scroll">
                    <x-ui.section-header :title="$service['title']" centered="false" animated="false" />
                    <div class="text-gray-800 font-figtree service-content">
                        {!! $service['content'] !!}
                    </div>
                    <p class="text-gray-600">
                        Our expert designers combine creativity with technical knowledge to create landscapes that are not
                        only visually stunning but also practical and sustainable. We consider factors like your property's
                        unique characteristics, local climate, and your lifestyle to create a design that truly works for
                        you.
                    </p>
                    <p class="text-gray-600">
                        Whether you're looking for a complete property renovation or focused improvements to a specific
                        area, our design services provide the foundation for a successful landscape project.
                    </p>
                </div>
            </div>
        </x-ui.section>
        ...
        <!-- Process Section -->
        <x-ui.section>
            <x-ui.section-header title="{{ $service['process']['section_title'] ?? 'Our Design Process' }}"
                subtitle="{{ $service['process']['section_subtitle'] ?? 'How we create your perfect landscape design' }}" />
        ...
        <!-- CTA Section -->
        <x-ui.cta title="Ready to Start Your Landscape Design?"
