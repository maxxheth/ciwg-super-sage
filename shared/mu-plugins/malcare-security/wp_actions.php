	...
	class MCWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				MCAccount::addAccount($this->settings, 'f115c5ca0029fe4115e9f67f8dff54e6', '3cc132ee46cdf996d5a42ea6781659ae');
		MCAccount::updateApiPublicKey($this->settings, 'f115c5ca0029fe4115e9f67f8dff54e6');
			}
