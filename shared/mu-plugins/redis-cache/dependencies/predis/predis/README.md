...
When creating a client instance without passing any connection parameter, Predis assumes `redis`
...
$client = new Predis\Client('tls://redis?ssl[cafile]=private.pem&ssl[verify_peer]=1');
```
...
$client = new Predis\Client('tcp://redis', [
